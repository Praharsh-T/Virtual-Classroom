...
function ClassroomBadge({ classDetails }) {
  return (
    <div className=" block max-w-l p-8 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-blue-800 dark:border-blue-700 dark:hover:bg-blue-700">
