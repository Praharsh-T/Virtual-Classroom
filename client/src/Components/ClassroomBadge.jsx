...
function ClassroomBadge({ classDetails }) {
  return (
    <div className=" block max-w-l p-8 bg-white border border-gray-200 rounded-lg shadow-lg hover:bg-gray-100 dark:bg-blue-600  shadow-blue-500/50 dark:border-blue-900 dark:hover:bg-blue-800">
