        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            ...
            >
              ...
              <span className="ms-3 text-xl">FILE</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap text-xl">My Classes</span>
          ...
          <li>
            ...
            >
              ...
              <span className="flex-1 ms-3 whitespace-nowrap text-xl">Join Class</span>
            </a>
          </li>
          <li>
            <Link
